...
describe("createProject", () =>  {
  ...
  it('should make post request', async () => {
    ...
    await apiInstance.createProject({})
  ...
  it('should pass data', async () => {
    ...
    mock = sinon.stub(client, "post").resolves({ data: "data" })
    await apiInstance.createProject(data)
    expect(mock.args[0]).to.eql(["/projects", data])
  })

  it('should return response in case of success', async () => {
    mock = sinon.stub(client, "post").resolves({ data: "data" })
    const response = await apiInstance.createProject({})
  ...
  it('should reject error in case of fail', async () => {
    ...
    return expect(apiInstance.createProject({})).to.be.rejectedWith(error);
  })
})
