...
describe("getUsersForManaging", () =>  {
  ...
  it('should make get request', async () => {
    ...
    await apiInstance.getUsersForManaging()
  ...
  it('should pass data', async () => {
    mock = sinon.stub(client, "get").resolves({ data: "data" })
    await apiInstance.getUsersForManaging()
    expect(mock.args[0]).to.eql(["/admin/users"])
  })

  it('should return response in case of success', async () => {
    mock = sinon.stub(client, "get").resolves({ data: "data" })
    const response = await apiInstance.getUsersForManaging()
  ...
  it('should reject error in case of fail', async () => {
    ...
    return expect(apiInstance.getUsersForManaging()).to.be.rejectedWith(error);
  })
})
