...
describe("unblockUserTimeReport", () =>  {
  ...
  it('should make put request', async () => {
    ...
    await apiInstance.unblockUserTimeReport(2, 5)
  ...
  it('should pass data', async () => {
    mock = sinon.stub(client, "put").resolves({ data: "data" })
    await apiInstance.unblockUserTimeReport(2, 5)
    expect(mock.args[0]).to.eql(["/admin/users/2/time_reports/5"])
  })

  it('should return response in case of success', async () => {
    mock = sinon.stub(client, "put").resolves({ data: "data" })
    const response = await apiInstance.unblockUserTimeReport(2, 5)
  ...
  it('should reject error in case of fail', async () => {
    ...
    return expect(apiInstance.unblockUserTimeReport(2, 5)).to.be.rejectedWith(error);
  })
})
